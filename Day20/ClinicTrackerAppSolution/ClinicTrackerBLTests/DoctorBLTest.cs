...
namespace ClinicTrackerBLTests
{
    public class DoctorBLTest
    {
        ...
        public void Setup()
        {
            ...
            Doctor doctor = new Doctor() { DocName = "Viji", Age = 30, PhoneNumber = "8786543453", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };
            doctorRepository.Add(doctor);
            doctor = new Doctor() { DocName = "Pavithra", Age = 30, PhoneNumber = "8786543453", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };
            doctorRepository.Add(doctor);
        ...
        {
            //Arrange
            Doctor doctor = new Doctor() { DocName = "Pavi", Age = 35, PhoneNumber = "878978553", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };
            //action
        ...
        {
            Doctor doctor = new Doctor() { Id = 1, DocName = "Pavi", Age = 35, PhoneNumber = "878978553", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };
            //Action
        ...
        {
            var doctor = doctorService.GetDoctorById(1);
            doctor.DocName = "Pavithra Pazhanivel";
        ...
        {
            Doctor doctor = new Doctor() { Id = 3, DocName = "Pavi", Age = 35, PhoneNumber = "878978553", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };
