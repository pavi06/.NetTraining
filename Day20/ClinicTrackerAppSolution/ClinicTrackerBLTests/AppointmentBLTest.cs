...
namespace ClinicTrackerBLTests
{
    public class AppointmentBLTest
    {
        ...
        public void Setup()
        {
            ...
            Doctor doctor = new Doctor() {Id=1, DocName = "Viji", Age = 30, PhoneNumber = "8786543453", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };

            Appointment appointment = new Appointment() { Id = 1, Patient=patient, Doctor=doctor, AppointmentDateTime=new DateTime(2024, 08, 12), AppointmentDescription="General checkup", AppointmentStatus="Not Completed" };
        ...
        {
            //Arrange
            Patient patient = new Patient() { PatientName = "Pavithra Pazhanivel", Age = 30, ContactAddress = "No.3 sai street, Korattur, Chennai", BloodGroup = "AB+ve", Gender = "Female", PhoneNumber = "9897654343" };
            Doctor doctor = new Doctor() { DocName = "Viji Sai", Age = 35, PhoneNumber = "8786543453", Experience = 10, Qualification = "MBBS", Specialization = "Neurologist" };

            Appointment appointment = new Appointment() { Id = 2, Patient = patient, Doctor = doctor, AppointmentDateTime = new DateTime(2024, 10, 24), AppointmentDescription = "General checkup", AppointmentStatus = "Completed" };
            //action
        ...
        {
            Appointment appointment = new Appointment() { Id = 3, Patient = new Patient(), Doctor = new Doctor(), AppointmentDateTime = new DateTime(2024, 10, 24), AppointmentDescription = "General checkup", AppointmentStatus = "Completed" };
