...
namespace ERequestTrackerModelLibrary.Migrations
{
    ...
    [Migration("20240511093930_solutionFeedback")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.Request", b =>
                {
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.RequestSolution", b =>
                {
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.SolutionFeedback", b =>
                {
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.Request", b =>
                {
                    b.HasOne("ERequestTrackerModelLibrary.Employee", "RequestClosedByEmployee")
                        .WithMany("RequestsClosed")
                        .HasForeignKey("RequestClosedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ERequestTrackerModelLibrary.Employee", "RaisedByEmployee")
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.RequestSolution", b =>
                {
                    b.HasOne("ERequestTrackerModelLibrary.Request", "RequestRaised")
                        .WithMany("RequestSolutions")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ERequestTrackerModelLibrary.Employee", "SolvedByEmployee")
            ...
            modelBuilder.Entity("ERequestTrackerModelLibrary.SolutionFeedback", b =>
                {
                    b.HasOne("ERequestTrackerModelLibrary.Employee", "FeedbackByEmployee")
                        .WithMany("FeedbacksGiven")
                        .HasForeignKey("FeedbackBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ERequestTrackerModelLibrary.RequestSolution", "Solution")
                        .WithMany("Feedbacks")
