...
namespace ERequestTrackerModelLibrary.Migrations
{
    ...
    [Migration("20240511093433_requestSolution")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeRequestTrackerModelLibrary.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeRequestTrackerModelLibrary.Request", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerModelLibrary.RequestSolution", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerModelLibrary.Request", b =>
                {
                    b.HasOne("EmployeeRequestTrackerModelLibrary.Employee", "RequestClosedByEmployee")
                        .WithMany("RequestsClosed")
                        .HasForeignKey("RequestClosedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EmployeeRequestTrackerModelLibrary.Employee", "RaisedByEmployee")
            ...
            modelBuilder.Entity("EmployeeRequestTrackerModelLibrary.RequestSolution", b =>
                {
                    b.HasOne("EmployeeRequestTrackerModelLibrary.Request", "RequestRaised")
                        .WithMany("RequestSolutions")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EmployeeRequestTrackerModelLibrary.Employee", "SolvedByEmployee")
